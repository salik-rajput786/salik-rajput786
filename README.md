...
- Interactive dashboards using Power BI & Excel  
- SQL-based data analysis and business insights  

👯 **Looking to Collaborate On**  
- Data Analysis projects  
- Dashboard development (Power BI / Excel)  
- Real-world analytics and business problem-solving  

🤝 **Looking for Help With**  
- Advanced SQL optimization  
- Power BI storytelling & dashboard design  
- Gaining industry-level experience in Data Analytics  
...
⚡ **Fun Fact**  
I enjoy transforming raw data into meaningful insights and continuously build real-world projects to grow as a Data Analyst.
